      ...
      <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
        ...
        {currentUser ? (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/40">
            <div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">
                Sign in with Google to protect your data
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Automatically backup student fees, class routines, attendance, and exam marks to Firebase Firestore.
              </p>
            </div>
            <button
              type="button"
              ...
              className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-sm shadow-indigo-600/20 transition flex items-center justify-center gap-2 shrink-0"
            >
