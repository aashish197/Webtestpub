        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          {currentUser ? (
            ...
            <button
              ...
              onClick={openAuthModal}
              className="flex items-center gap-2 px-2.5 py-1.5 text-xs sm:text-sm font-semibold rounded-lg bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 shadow-2xs hover:shadow-xs transition"
